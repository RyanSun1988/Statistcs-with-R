...
plot_ss(x=hits, y=runs,data = mlb11)
...
plot_ss(data = mlb11,y=runs,x=bat_avg)
...
```{r diag}
#hits
ggplot(data=m2,aes(x=.fitted, y=.resid))+geom_point()+geom_hline(yintercept = 0,linetype="dashed")+xlab("Fitted value")+ylab("Residuals")
ggplot(data = m2,aes(sample=.resid))+stat_qq()
#homeruns
ggplot(data=m3,aes(x=.fitted,y=.resid))+geom_point()+geom_hline(yintercept = 0,linetype="dashed")+xlab("Fitted Value")+ylab("Residuals")
ggplot(data=m3,aes(sample=.resid))+stat_qq()
#wins
ggplot(data=m4, aes(x=.fitted,y=.resid))+geom_point()+geom_hline(yintercept = 0,linetype="dashed")+xlab("Fitted Value")+ylab("Residuals")
ggplot(data=m4,aes(sample=.resid))+stat_qq()
#new_onbase
ggplot(data=m5,aes(x=.fitted, y=.resid))+geom_point()+geom_hline(yintercept = 0,linetype="dashed")+xlab("Fitted Value")+ylab("Residuals")
ggplot(data=m5,aes(sample=.resid))+stat_qq()
#new_slug
ggplot(data=m6,aes(x=.fitted,y=.resid))+geom_point()+geom_hline(yintercept = 0,linetype="dashed")+xlab("Fitted Value")+ylab("Residual")
ggplot(data = m6,aes(sample=.resid))+stat_qq()
#new_obs
ggplot(data=m7,aes(x=.fitted,y=.resid))+geom_point()+geom_hline(yintercept = 0,linetype="dashed")+xlab("Fitted Value")+ylab("Residuals")
ggplot(data=m7,aes(sample=.resid))+stat_qq()
ggplot(data=m8,aes(x=.fitted,y=.resid))+geom_point()+geom_hline(yintercept = 0,linetype="dashed")+xlab("Fitted Value")+ylab("Residuals")
ggplot(data=m8,aes(sample=.resid))+stat_qq()
